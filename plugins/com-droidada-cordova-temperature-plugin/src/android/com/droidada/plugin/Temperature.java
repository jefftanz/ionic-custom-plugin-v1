...
public class Temperature extends CordovaPlugin implements SensorEventListener {
  ...
  public void isDeviceCompatible() {
    String msg = this.sensor != null ? "This device is compatible" : "123 Sorry, this device doesn't have a temperature sensor";
  ...
  public void start () {
    ...
    if(this.sensor != null) {
      ...
      Toast.makeText(cordova.getActivity(), "We're detecting the temperature of your surroundings...", Toast.LENGTH_LONG).show();
        ...
        this.stop();
        Toast.makeText(cordova.getActivity(), "456 Sorry this device does not have a Temperature sensor" , Toast.LENGTH_LONG).show();
        this.callbackContext.error("789 Sorry this device does not have a Temperature sensor");
    }
  }
